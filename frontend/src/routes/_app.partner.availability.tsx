...
export const Route = createFileRoute("/_app/partner/availability")({
  ...
  head: () => ({ meta: [{ title: "Availability â€” NurseConnect" }] }),
});
...
const SLOTS = [
  { id: "Morning",   label: "Morning",   time: "6:00 â€“ 12:00",  icon: "â˜€ï¸" },
  { id: "Afternoon", label: "Afternoon", time: "12:00 â€“ 18:00", icon: "ðŸŒ¤" },
  { id: "Evening",   label: "Evening",   time: "18:00 â€“ 22:00", icon: "ðŸŒ™" },
  { id: "Night",     label: "Night",     time: "22:00 â€“ 6:00",  icon: "ðŸŒƒ" },
];
